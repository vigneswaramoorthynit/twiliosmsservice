...
import com.hybrisapp.twilioSMSService.service.impl.DefaultTwilioSMSServiceService;
 ...
 */
@IntegrationTest
public class DefaultTwilioSMSServiceServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "twilioSMSServicePlatformLogo";

		// when
		final String logoUrl = twilioSMSServiceService.getHybrisLogoUrl(logoCode);
