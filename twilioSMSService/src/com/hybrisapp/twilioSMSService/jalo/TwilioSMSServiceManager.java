...
/**
 * This is the extension manager of the TwilioSMSService extension.
 */
public class TwilioSMSServiceManager extends GeneratedTwilioSMSServiceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TwilioSMSServiceManager.class);
	 ...
	 */
	public static TwilioSMSServiceManager getInstance()
	{
		return (TwilioSMSServiceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TwilioSMSServiceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TwilioSMSServiceManager() // NOPMD
	{
		LOG.debug("constructor of TwilioSMSServiceManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TwilioSMSServiceManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TwilioSMSServiceManager called, current tenant: {}", getTenant().getTenantID());
	}
