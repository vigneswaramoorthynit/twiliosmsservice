...
public class DefaultTwilioSMSServiceService implements TwilioSMSServiceService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTwilioSMSServiceService.class);
	...
	{
		return DefaultTwilioSMSServiceService.class.getResourceAsStream("/twilioSMSService/sap-hybris-platform.png");
	}
